...
This project’s Docker image now uses Bun as the JavaScript runtime and package manager (`oven/bun:1-alpine`).
...
> You do not need Bun installed on the VPS when using Docker; Bun is included in the container image.
